...
''',
    ...
    attack_group.add_argument(
        '-w', '--wordlist',
        type=str,
        help='Use a custom wordlist with PINs'
    )
    ...
    # Validation logic for wordlist and bruteforce
    ...
    if args.delay and not (args.bruteforce or args.wordlist):
        parser.error('argument -d/--delay can only be used with -B/--bruteforce or -w/--wordlist')
